...
export function hasProperty<T extends Item>(
	item: Item | null,
	prop: string
): item is T {
	return item != null && Object.prototype.hasOwnProperty.call(item, prop);
}

type Lookup = Item | LookupItem | null;

export function isItemSpecificType(
	item: Lookup,
	itemType: "annotation"
): item is Annotation;
export function isItemSpecificType(
...
export function isItemSpecificType(
	item: Lookup,
	itemType: "calloutArrow"
): item is CalloutArrow;
...
export function isItemSpecificType(
	item: Lookup,
	itemType: "quantityLabel"
): item is QuantityLabel;
export function isItemSpecificType(
	item: Lookup,
	itemType: "rotateIcon"
): item is RotateIcon;
...
export function isItemSpecificType(
	item: Lookup,
	itemType: "submodel"
): item is SubmodelItem;
export function isItemSpecificType(
	item: Lookup,
	itemType: "submodelImage"
): item is SubmodelImage;
export function isItemSpecificType(
	item: Lookup,
...
export function isStepParent(t: any): t is StepParent {
	return Object.prototype.hasOwnProperty.call(t, "steps");
}

export function isQuantityLabelParent(t: any): t is QuantityLabelParent {
	return Object.prototype.hasOwnProperty.call(t, "quantity");
}
...
export function isTemplateType(p: string): p is keyof Template {
	return Object.prototype.hasOwnProperty.call(defaultTemplate, p);
}
