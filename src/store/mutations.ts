...
import {
	AnnotationMutationInterface,
	AnnotationMutations,
} from "../store/annotation_setters";
...
import {
	CalloutMutationInterface,
	CalloutMutations,
} from "../store/callout_setters";
...
import {
	PLIItemMutationInterface,
	PLIItemMutations,
} from "../store/pli_item_setters";
...
import {
	SubmodelMutationInterface,
	SubmodelMutations,
} from "../store/submodel_setters";
import {
	TemplatePageMutationInterface,
	TemplatePageMutations,
} from "../store/template_page_setters";
import {
	TitlePageMutationInterface,
	TitlePageMutations,
} from "../store/title_page_setters";
